...
public class PathBroadcast
{
	...
	public static void write(RobotController rc, Path path, int band) throws GameActionException
	{
	...
	public static Path read(RobotController rc, int band) throws GameActionException
	{
