...
public class StateMap
{
	...
	public void broadcast(RobotController rc, MapLocation loc, State state) throws GameActionException
	{
		rc.broadcast(band + Channels.locToInt(loc), stateToInt(state));
	}
	
	public State read(RobotController rc, MapLocation loc) throws GameActionException
	{
