...
public abstract class Channels
{
	...
	public static void broadcastAlertLevel(RobotController rc, AlertLevel level) throws GameActionException
	{
		rc.broadcast(alertLevel, level.ordinal());
	}
	
	public static AlertLevel readAlertLevel(RobotController rc) throws GameActionException
	{
	...
	public static void printBand(RobotController rc, int start, int size) throws GameActionException
	{
