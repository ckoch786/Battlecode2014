...
public class RadarMap
{
	...
	public void broadcast(RobotController rc, MapLocation loc, int enemyCount) throws GameActionException
	{
		rc.broadcast(band + Channels.locToInt(loc), enemyCount);
	}
	
	public int read(RobotController rc, MapLocation loc) throws GameActionException
	{
